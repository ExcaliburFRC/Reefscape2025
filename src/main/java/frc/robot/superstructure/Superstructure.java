...
public class Superstructure {
    ...
    private Command setStateCommand(State state, BooleanSupplier activateWheels) {
        Command setStateCommand = new SequentialCommandGroup(
    ...
    public Command scoreCoralCommand(int level, BooleanSupplier atPose) {
        State state;
        switch (level) {
        ...
        return setStateCommand(
                ...
                m_gripper.m_coralTrigger.negate()
        ).andThen(
                setStateCommand(State.DEFAULT, () -> true)
        );
    }
